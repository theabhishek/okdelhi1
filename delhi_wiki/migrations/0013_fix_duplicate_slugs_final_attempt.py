...
def fix_duplicate_slugs_final_attempt(apps, schema_editor):
...
class Migration(migrations.Migration):
    dependencies = [
        ('delhi_wiki', '0012_fix_duplicate_slugs_again'),
    ]

    operations = [
        migrations.RunPython(fix_duplicate_slugs_final_attempt, reverse_fix),
    ] 